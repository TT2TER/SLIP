...
def create_dataset(dataset, config, min_scale=0.5):#1
...
def create_sampler(datasets, shuffles, num_tasks, global_rank):#1
    samplers = []
...
def create_loader(datasets, samplers, batch_size, num_workers, is_trains, collate_fns):#1
    loaders = []
